...
const CompanyDetails = () => {
    ...
    if (!company) {
        return (
            <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-center text-lg text-red-500 py-10 min-h-[60vh]"
            >
    ...
    return (
        <>
            <Helmet>
                <title>Company Details-{company.name} | JobTrack</title>
            </Helmet>
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="py-12 w-11/12 mx-auto min-h-screen"
            >
                {/* Company Info */}
                <motion.div
